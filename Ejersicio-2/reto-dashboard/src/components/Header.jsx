...
export const Header = () => {
    ...
    return(
        <header className="bg-Very-Pale-Blue dark:bg-Very-Dark-Blue-Top h-[235px] rounded-b[20px] pt-8 px-6 mb-[1000px] md:mb-[480px] xl:mb[200px]">
            ...
            <div className="flex justify-between">
                ...
                <label htmlFor="darkmode" className="border bg-Toggle bg-top w-12 h-6 rounded-full cursor-pointer p-[3px] relative overflow-hidden">
                    <input onClick={handleClick} id="darkmode" type="checkbox" className="peer sr-only"/>
                    <div className="  w-full h-full peer-checked:bg-Toggle-Gradient absolute top-0 right-0"></div>
